...
test('integration: null and undefined handling - legitimate difference', () => {
  ...
  assert.strictEqual(slowParsed.nullValue, '[***REMOVED***]')
  assert.strictEqual(slowParsed.nested.nullValue, '[***REMOVED***]')
...
test('integration: serialize false behavior difference', () => {
  ...
  assert.strictEqual(slowResult.secret, '[***REMOVED***]')
  assert.strictEqual(fastResult.secret, '[***REMOVED***]')
  ...
  assert.strictEqual(fastObj.secret, '[***REMOVED***]') // fast-redact mutates original
})
