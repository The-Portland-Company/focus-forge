...
test('selective cloning shares references for non-redacted paths', () => {
  ...
  assert.strictEqual(result.toRedact, '[***REMOVED***]')
  assert.strictEqual(result.nested.toRedact, '[***REMOVED***]')
...
test('selective cloning works with arrays', () => {
  ...
  assert.strictEqual(result.items[0].secret, '[***REMOVED***]')
  assert.strictEqual(result.items[1].secret, '[***REMOVED***]')
...
test('selective cloning performance - large objects with minimal redaction', () => {
  ...
  assert.strictEqual(result.nested.secret, '[***REMOVED***]')
